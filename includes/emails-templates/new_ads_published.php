...
$templates_data_html['new_ads_published'] = '<div style="background: #f5f5f5; color: #333; font-size: 14px; line-height: 20px; font-family: Arial, sans-serif;">
...
<p style="font-size: 14px; line-height: 20px; color: #333; font-family: Arial, sans-serif;">{user_name} has published a ads</p>
...
{ads_content}</p>
<div style="padding: 10px 0 0;"><a class="btn" style="color: #fff; border-radius: 3px; text-decoration: none; background-color: #51b3ff; padding: 10px 20px; font-size: 14px; font-family: Arial, sans-serif;" href="{ads_edit_url}">Edit Ads</a></div>
</td>
</tr>
</tbody>
</table>
