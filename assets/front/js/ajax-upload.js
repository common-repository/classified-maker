jQuery(document).ready(function ($) {
    ...
    var CLASSIFIED_MAKER_FILE_UPLOAD = {
        ...
        attach:function () {
            ...
            if (classified_maker_file_uploader.upload_enabled !== '1') {
                return
            }

            var uploader = new plupload.Uploader(classified_maker_file_uploader.plupload);
            ...
            uploader.bind('FileUploaded', function (up, file, response) {
                ...
                if (result.success) {
					...
					ads_thumbs  = $('#classified_maker_ads_thumbs').val();
					...
					$('#classified_maker_ads_thumbs').val(ads_thumbs);
